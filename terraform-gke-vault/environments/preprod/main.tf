...
# TOGAF Implementation Governance: final rehearsal of production
# deployment and cutover runbooks. Architecturally identical to prod
# (private control-plane endpoint, Binary Authorization, deletion
# protection, dedicated Vault node pool, STABLE release channel).
# -----------------------------------------------------------------------------
