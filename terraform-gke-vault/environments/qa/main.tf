# -----------------------------------------------------------------------------
# Environment: QA
# TOGAF Opportunities & Solutions / Migration Planning: functional validation
# environment. Same architecture building blocks as dev, promoted with
# slightly higher availability (non-preemptible nodes, 3-node Vault Raft).
# -----------------------------------------------------------------------------
