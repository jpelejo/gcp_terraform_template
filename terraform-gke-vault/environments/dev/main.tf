# -----------------------------------------------------------------------------
# Environment: DEV
# TOGAF Opportunities & Solutions / Migration Planning: this is the lowest-risk
# environment where new architecture building blocks are first realized.
# Composes the shared modules; only variable values differ from other envs.
# -----------------------------------------------------------------------------
